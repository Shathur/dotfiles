...
com! ShowMaps call s:ShowMaps(0)      " Enable :ShowMaps to call the function
com! ShowMapsVerbose call s:ShowMaps(1)

nnoremap <leader>m :ShowMaps<CR>
nnoremap <leader>M :ShowMapsVerbose<CR>
